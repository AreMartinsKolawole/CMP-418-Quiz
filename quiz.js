...
const questions = [
    ...
    { question: 'An interrupt request is part of the control lines on the bus. It signals the processor that an event requires immediate attention', options: ['False', 'True', 'Partially'], correctAnswer: 'True' },
